...
$id = $_SESSION['id'];
        ...
        if (mysqli_num_rows($result) == 1) 
        {
            ...
            echo "<script>alert('Password updated successfully.'); window.location.href='adlogged.php';</script>";
        }
        else 
        {
            echo "<script>alert('Please Enter the valid ID'); window.location.href= 'adlogged.php';</script>";
        }
 }
?>
<!DOCTYPE html>
