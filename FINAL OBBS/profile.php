...
$sql = "UPDATE users SET fname='$fullname', mobno='$mobno',email='$email' where id ='$user_id'";
							...
							<?php
					 		...
					 		<div class="form-group row">
                              	<label class="col-form-label col-md-4">Full Name:</label>
                                	<div class="col-md-12">
                                		<input type="text" value="<?php echo $row['fname'];?>" name="fname" required="true" class="form-control" >
                                	</div> 
                            </div>
                            <div class="form-group row">
