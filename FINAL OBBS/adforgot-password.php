...
{ 
    ...
    if($result == TRUE)
    {
        echo "<script>alert('Password updated successfully.'); window.location.href='adlogin.php';</script>";
    }
    else
    {
        echo "<script>alert('Failed to update Password.'); window.location.href='adforgot-password.php';</script>";
    }
...
<link href='//fonts.googleapis.com/css?family=Roboto+Condensed:400,700italic,700,400italic,300italic,300' rel='stylesheet' type='text/css'>
 <script>
    function valid() {
    var id = document.forms["chngpwd"]["id"].value;
                ...
                <div class="col-md-6 contact-form-right">
                    ...
                    <div class="agileinfo-contact-form-grid">
                        <form action="#" method="post" name="chngpwd" onsubmit="return valid();">
                             <input type="text" class="form-control"  name="id" maxlength="10" placeholder="Enter ID" required>
